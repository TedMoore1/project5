...
public class FieldAccess {
    public static void main(String[] args) {
        ...
        f.i = 0;
        i = f.i;
        StaticJavaLib.assertTrue(f.i + 0 == 0);
        StaticJavaLib.assertTrue(  i == 0);

        b = new FieldAccessBar();
        b.i = 1;
        i = b.i;
        StaticJavaLib.assertTrue(0+ b.i == 1);
        StaticJavaLib.assertTrue(  i == 1);

        b.f = f;
        b.f.i = 2;
        i = b.f.i;
        StaticJavaLib.assertTrue(b.f.i + 0 == 2);
        StaticJavaLib.assertTrue(    i == 2);

        b.f.i = 3;
        f.i = b.f.i;
        StaticJavaLib.assertTrue(0+ b.f.i == 3);
        ...
        b.f.i++;
        StaticJavaLib.assertTrue(b.f.i - 0 == 6);
    }
}
